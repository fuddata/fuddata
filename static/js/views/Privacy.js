...
export default class extends AbstractView {
  ...
  async getHtml() {
    ...
    <ul>
      ...
      your email address, name, phone number, and postal address.</li>
      <li><strong>Usage Data:</strong> We may also collect information on how the Service is accessed and used.
    ...
    <p>Our Service uses these "cookies" to collect information and to improve our Service.
