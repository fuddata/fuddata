...
For us security and user privacy are most important design priciples which why we built this from scratch without using UI frameworks, minimized usage of 3rd party libraries, we only use privacy friendly 3rd party services and we made whole codebase publicly available as open source so anyone can review it.
